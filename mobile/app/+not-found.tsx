...
// Route screen forever. With this file present, "/" resolves to the +not-found
// screen (briefly, invisibly — it renders null), SessionGate mounts as its parent
// layout, and its declarative Stack.Protected guards (see app/_layout.tsx) route
// to /login (or the employee/client shell) immediately — no imperative redirect
// involved. Verified via cold-boot in the iOS Simulator — see task-4-report.md.
